...
def main(nrows=None):
    # Convert train
    train = pd.read_csv('../input/train_v2.csv.zip', dtype='object', nrows=nrows, encoding='utf-8')
    train = develop_json_fields(df=train)
    logger.info('Train done')

    # Convert test
    test = pd.read_csv('../input/test_v2.csv.zip', dtype='object', nrows=nrows, encoding='utf-8')
    ...
    test.to_csv('../input/extracted_fields_test_v2.csv', index=False)
    train.to_csv('../input/extracted_fields_train_v2.csv', index=False)
